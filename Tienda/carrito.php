                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td>Bs <?php echo $arregloCarrito[$i]['Precio']; ?></td>
                        <td>
                        ...
                        <td class="cantidad<?php echo $arregloCarrito[$i]['Id']?>">Bs <?php echo $arregloCarrito[$i]['Precio'] * $arregloCarrito[$i]['Cantidad']; ?></td>
              ...
              <div class="col-md-7">
                <div class="row">
                  <div class="col-md-12 text-right border-bottom mb-5">
                    <h3 class="text-black h4 text-uppercase">Total de Pedido</h3>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6 text-right">
                    <strong class="text-black">Bs <?php echo $total;?></strong>
                  </div>
                </div>
                <div class="row mb-5">
                  <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='checkout.php'">Cofirmar Pedido</button>
                  </div>
                </div>
              </div>
            </div>
